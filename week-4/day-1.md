# Week 4 — Responsive Design | [NextGen Arts](https://nextgenarts.pk)
...
**Mobile-First (Recommended):** Write base styles for mobile, then add complexity for larger screens using 
`min-width`.
...
[← Back to Week 4](README.md) | [Day 2 →](day-2.md)
